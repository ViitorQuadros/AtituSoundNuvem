...
import br.edu.atitus.poo.atitusound.serviceimp.ArtistServiceImpl;
...
public class ArtistController {
	...
	public ResponseEntity<Page<List<ArtistEntity>>> getFind(
			@PageableDefault(page = 0, size = 10, sort = "name", direction = Direction.ASC) Pageable pageable, @RequestParam String name){
